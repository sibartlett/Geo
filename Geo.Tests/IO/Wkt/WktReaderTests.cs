...
public class WktReaderTests
{
    ...
    public void Point()
    {
        ...
        Assert.AreEqual(Geo.Geometries.Point.Empty, empty);
    }
    ...
    public void Polygon()
    {
        ...
        Assert.AreEqual(Geo.Geometries.Polygon.Empty, empty);
    }
    ...
    public void Triangle()
    {
        ...
        Assert.AreEqual(Geo.Geometries.Triangle.Empty, empty);
    }
    ...
    public void MultiPoint()
    {
        ...
        Assert.AreEqual(new MultiPoint(new Point(65.9, 0), new Point(9, -34.5), new Point(40, -20), new Point(65.9, 0)),
            none);
